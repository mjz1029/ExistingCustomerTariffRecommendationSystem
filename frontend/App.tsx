...
import { TariffPlan, RecommendationResult, PageView, UserRecord, AIProviderConfig } from './types';
...
import { plansApi, usersApi, recommendationsApi, aiApi } from './services/api';
...
const App: React.FC = () => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Run recommendation engine on backend
